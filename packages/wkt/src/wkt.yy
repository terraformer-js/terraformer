...
geometry_collection
    : geometry_collection COMMA geometry
        { $$ = $1.addGeometry($3); }
    | geometry
        { $$ = new GeometryList($1); }
    ;
